  ...
  <section class="ClassName">
    <div class="container px-6 py-16 mx-auto text-center">
      ...
      <div class="flex flex-wrap justify-around mt-20">
        <img class="object-cover hover:scale-105 duration-100 w-full md:w-1/2 lg:w-1/4 rounded-xl" src="../assets/img/avatar.png" />
        <img class="object-cover hover:scale-105 duration-100 w-full md:w-1/2 lg:w-1/4 rounded-xl mt-4 md:mt-0" src="../assets/img/avatarSilence.png" />
        <img class="object-cover hover:scale-105 duration-100 w-full md:w-1/2 lg:w-1/4 rounded-xl mt-4 md:mt-0" src="../assets/img/avatarStarEye.png" />
      </div>
    </div>
  </section>
</template>
